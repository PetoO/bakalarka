...
class Video_compose():
    def __init__(self, file, video, handler="simple_frame_handler", output="output.avi"):
        ...
        self.precision = 0.5
        print
        "Creating data collection from given file."
    ...
    def start_composing(self):
        ...
        last = 0
        for i in range(0, int(frames_count)):
